...
- **summarize**: [상태/결과/장애원인] 중심의 **3라인 고밀도 요약** 생성. (서술형 배제, 정보 밀도 극대화)
- **archive**: **3세션 이상** 지난 데이터나 폐기된 계획을 즉시 `docs/archives/`로 격리.
...
- **세션 체크포인트**: 세션 종료 전 `CURRENT_STATE.md`를 **1000토큰 이내**로 정제.
